...
export const LISTINGS_ROUTES: Routes = [
  {
    path: '',
    loadComponent: () => import('./listing-list/listing-list.component').then(m => m.ListingListComponent),
  },
  {
    path: 'create',
  ...
  },
  {
    path: ':id/edit',
    canActivate: [sellerGuard],
    loadComponent: () => import('./edit-listing/edit-listing.component').then(m => m.EditListingComponent),
  },
];
