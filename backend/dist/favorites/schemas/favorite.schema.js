...
__decorate([
    ...
    __metadata("design:type", mongoose_2.Types.ObjectId)
], Favorite.prototype, "productListingId", void 0);
exports.Favorite = Favorite = __decorate([
    (0, mongoose_1.Schema)({ timestamps: { createdAt: true, updatedAt: false }, collection: 'favorites' })
], Favorite);
exports.FavoriteSchema = mongoose_1.SchemaFactory.createForClass(Favorite);
exports.FavoriteSchema.index({ userId: 1, productListingId: 1 }, { unique: true });
exports.FavoriteSchema.index({ userId: 1 });
