    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                { name: category_schema_js_1.Category.name, schema: category_schema_js_1.CategorySchema },
            ]),
        ],
        controllers: [categories_controller_js_1.CategoriesController],
        providers: [categories_service_js_1.CategoriesService],
        exports: [categories_service_js_1.CategoriesService, mongoose_1.MongooseModule],
    })
], CategoriesModule);
