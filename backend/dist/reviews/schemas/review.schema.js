...
__decorate([
    ...
    __metadata("design:type", mongoose_2.Types.ObjectId)
], Review.prototype, "productListingId", void 0);
__decorate([
    (0, mongoose_1.Prop)({ type: Number, required: true, min: 1, max: 5 }),
    __metadata("design:type", Number)
], Review.prototype, "rating", void 0);
__decorate([
    (0, mongoose_1.Prop)({ type: String, maxlength: 2000, default: '' }),
    __metadata("design:type", String)
], Review.prototype, "text", void 0);
__decorate([
    (0, mongoose_1.Prop)({ type: String, enum: ReviewStatus, default: ReviewStatus.APPROVED }),
    __metadata("design:type", String)
...
exports.ReviewSchema.index({ sellerId: 1 });
exports.ReviewSchema.index({ productListingId: 1 });
exports.ReviewSchema.index({ reviewerId: 1, productListingId: 1 }, { unique: true });
